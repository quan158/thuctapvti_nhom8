        ...
        <div class="row">
            ...
            <div class="col-md-3 mb-5">
                ...
                <table class="product-category">
                    ...
                    ?>
                    <tr class="<?php echo $current_cat == 'Bird' ? 'active' : ''; ?>">
                        <td><a href="shop.php?cat=Bird">Chim</a></td>
                    </tr>
                    <tr class="<?php echo $current_cat == 'Dog' ? 'active' : ''; ?>">
                        <td><a href="shop.php?cat=Dog">Chó</a></td>
                    </tr>
                    <tr class="<?php echo $current_cat == 'Cat' ? 'active' : ''; ?>">
                        <td><a href="shop.php?cat=Cat">Mèo</a></td>
                    </tr>
                    <tr class="<?php echo $current_cat == 'Other' ? 'active' : ''; ?>">
                        <td><a href="shop.php?cat=Other">Các loại khác</a></td>
                    </tr>
                </table>
            </div>
                    ...
                    if (!isset($_GET["cat"])) {
                        ...
                        foreach ($select_pro as $pro) {
                            ...
                            <div class="col-md-6 col-lg-3 ftco-animate">
                                <div class="product">
                                    <a href="product-single.php?id_pro=<?php echo $pro['id_pro'] ?>" class="img-prod">
                                        <img class="img-fluid" src="../Admin/upload/<?php echo $pro['image'] ?>" alt="<?php echo $pro['name_pro'] ?>">
